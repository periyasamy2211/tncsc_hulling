...
class AddPaddyReceivedScreen extends StatefulWidget {
  @override
  _AddPaddyReceivedScreenState createState() => _AddPaddyReceivedScreenState();
}

class _AddPaddyReceivedScreenState extends State<AddPaddyReceivedScreen> {
  // Form fields
  DateTime selectedDate = DateTime.now();
  String variety = 'Common';
  ...
  Future<void> savePaddyReceivedData() async {
    try {
      await FirebaseFirestore.instance.collection('paddy_received').add({
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Variety Dropdown
              Text("Variety", style: TextStyle(fontSize: 16)),
              DropdownButton<String>(
                value: variety,
                isExpanded: true,
                items: ['Common', 'Grade-A'].map((v) {
