...
class AddFrkReceivedScreen extends StatefulWidget {
  @override
  _AddFrkReceivedScreenState createState() => _AddFrkReceivedScreenState();
}

class _AddFrkReceivedScreenState extends State<AddFrkReceivedScreen> {
  // Form fields
  ...
  Future<void> saveFrkReceivedData() async {
    try {
      await FirebaseFirestore.instance.collection('frk_received').add({
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Invoice Number
              buildTextField("Invoice Number", (value) {
                invoiceNumber = value;
              }),
